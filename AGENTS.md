...
- **Testing**: Vitest (unit/integration, 708 tests, 95 files), Playwright (E2E, 49+ tests, 5 spec files)
...
pnpm test         # Run unit/integration tests (708 tests, 95 files; 2026-07-22 baseline)
