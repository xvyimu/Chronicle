...
- **Testing**: Vitest (unit/integration, 688 tests, 93 files), Playwright (E2E, 49 tests, 5 spec files)
...
pnpm test         # Run unit/integration tests (688 tests, 93 files; 2026-07-21 baseline)
