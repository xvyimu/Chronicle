...
- **Testing**: Vitest (unit/integration, 700 tests, 94 files), Playwright (E2E, 49 tests, 5 spec files)
...
pnpm test         # Run unit/integration tests (700 tests, 94 files; 2026-07-21 baseline)
