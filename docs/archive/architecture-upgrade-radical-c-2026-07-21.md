...
> **历史快照（2026-09-21 归档）**：本文件是 2026-07-21 的规划快照，已移入 `docs/archive/`，**不再**是现行 SSOT。列车进度以根 [TODO.md](../../TODO.md) 与 [HANDOFF.md](../HANDOFF.md) 为准（T1–T3 已合、T4 决策维持 Fuse、T7 部分完成；T5/T6/T8 未启动）。正文按当时事实保留，不为对齐当前统计而改写。

> **状态**：规划 SSOT（2026-07-21）· **T1–T3 已合 master** · tip 见 `docs/HANDOFF.md`  
