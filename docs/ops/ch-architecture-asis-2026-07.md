...
> 本文件原指向的 `D:\orca\docs\architecture-stack-refactor-master-2026-07-22.md` 描述的是
> **已废止的目标栈**（六仓口径），保留本文件仅供追溯测绘结论，**不要据此排期或选型**。
...
> ~~**技术栈主参考**：`D:\orca\docs\architecture-stack-refactor-master-2026-07-22.md`~~ ← **已废止**，见顶部横幅  
