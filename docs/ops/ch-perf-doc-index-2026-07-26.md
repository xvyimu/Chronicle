...
| **架构优化研究** | `docs/archive/architecture-optimization-research-2026-07-21.md`（v2/v3/v4） | 架构优化调研（2026-09-21 全部归档） |
| **激进架构升级** | `docs/archive/architecture-upgrade-radical-c-2026-07-21.md`                 | 激进方案评估（2026-09-21 归档）     |
