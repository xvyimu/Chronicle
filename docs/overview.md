...
| [架构优化整合调研 v3 2026-07-21](./architecture-optimization-research-2026-07-21-v3.md) | **现行决策**：G2 上线后重扫、v2 §51 表单决议落地核对、Q21–Q30 ship 清单、React Compiler/FS cache 接入评估 | 接入项或卫生债变化             |
